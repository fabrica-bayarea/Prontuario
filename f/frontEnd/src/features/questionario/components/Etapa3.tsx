  ...
  return (
    <div className="form-grid">
      <div className="col-12">
        <fieldset>
          <legend>Qual serviço do IESB você está buscando? *</legend>
          ...
          {errors.servicoIESB && <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.servicoIESB.message}</span>}
        </fieldset>
      </div>

      <div className="col-12">
        <fieldset>
          <legend>Antes de procurar o IESB, você buscou atendimento em outro local? *</legend>
          <div className="checkbox-group">
            {[
          ...
          {errors.antesIESB && <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.antesIESB.message}</span>}
        </fieldset>
      </div>

      <div className="col-12">
        <fieldset>
          <legend>Você possui encaminhamento médico ou de outro profissional? *</legend>
          ...
          {errors.encaminhamentoMedico && <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.encaminhamentoMedico.message}</span>}
        </fieldset>
      </div>

...
function Etapa2({ register, errors, watch, setValue, proximaEtapa, anteriorEtapa }: EtapaProps) {
  ...
  const handleResidemCasaChange = (e) => {
    ...
    if (value === 'naoTem') {
      ...
      if (checked) {
        setValue('residemSuaCasa', [...residemSuaCasa.filter((v) => v !== 'naoTem'), value], {
          shouldValidate: true,
        });
      } else {
        setValue(
          'residemSuaCasa',
          residemSuaCasa.filter((v) => v !== value),
          { shouldValidate: true }
        );
      }
    }
          ...
          {acompanhamentoMedico === 'Sim' && (
            <div style={{ marginTop: '15px' }}>
              <div
                ...
                style={{ flexDirection: 'row', gap: '20px', marginBottom: '10px' }}
              >
            ...
            >
              ...
              {gastosAlimentacao.includes(id) && (
                <input
                  ...
                  placeholder="R$"
                  style={{ width: '120px', padding: '4px 8px' }}
                  value={valoresGastosAlimentacao[id] || ''}
                  onChange={(e) =>
        ...
        <fieldset>
          ...
          <div className="checkbox-group">
            {[
              ...
              { id: 'conhecidoIESB', label: 'Conheço alguém que estuda ou trabalha no IESB' },
              ...
              <div key={id} className="checkbox-option">
                <input
                  ...
                  id={id}
                  value={id}
                  checked={comoSoubeIESB.includes(id)}
                  onChange={(e) => handleCheckboxArray(e, 'comoSoubeIESB', comoSoubeIESB)}
                />
                <label htmlFor={id} style={{ marginBottom: 0 }}>
                  {label}
                </label>
            ...
            <>
              <div className="campo">
                <label htmlFor="fonteRedeSocio">
                  Especifique a rede sócio-assistencial: <span className="required">*</span>
                </label>
              ...
              {fonteRedeSocio === 'Outro' && (
                <div className="campo">
                  <label htmlFor="outroFonteRedeSocio">
                    Especifique: <span className="required">*</span>
                  </label>
                  <input
                    type="text"
                    {...register('outroFonteRedeSocio')}

    ...
    <div className="flex-col-container">
      ...
      <div className="flex-row w-full">
        <div className="input-group w-cpf">
          ...
          {errors.cpf && (
            <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.cpf.message}</span>
          )}
        </div>
        <div className="input-group w-half">
      ...
      <div className="flex-row w-full">
        <div className="w-half">
          <fieldset>
            ...
            {errors.estadoCivil && (
              <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.estadoCivil.message}</span>
            )}
          </fieldset>
        </div>
        ...
        <div className="w-half">
          <fieldset>
            ...
            {errors.genero && (
              <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.genero.message}</span>
            )}
          </fieldset>
        </div>
      </div>
      ...
      <div className="w-full">
        <fieldset>
          ...
          {errors.corRaca && (
            <span style={{ color: 'red', fontSize: '0.8em' }}>{errors.corRaca.message}</span>
          )}
        </fieldset>
      </div>
      ...
      <div className="w-full">
        <fieldset>
          ...
          {errors.clinicaAtendimento && (
            <span style={{ color: 'red', fontSize: '0.8em' }}>
              {errors.clinicaAtendimento.message}
            </span>
          )}
          ...
          {clinicaAtendimento && (
            <div className="input-group w-full" style={{ marginTop: '15px' }}>
              ...
              {errors.areaAtendimento && (
                <span style={{ color: 'red', fontSize: '0.8em' }}>
                  {errors.areaAtendimento.message}
                </span>
              )}
            </div>
          )}
      ...
      <div className="w-full">
        <fieldset>
          ...
          {errors.classAtendimento && (
            <span style={{ color: 'red', fontSize: '0.8em' }}>
              {errors.classAtendimento.message}
            </span>
          )}
        </fieldset>
      </div>
      ...
      <div className="input-group w-full">
        ...
        {errors.atendimentoParaQuem && (
          <span style={{ color: 'red', fontSize: '0.8em' }}>
            {errors.atendimentoParaQuem.message}
          </span>
        )}

        {atendimentoParaQuem === 'Outra pessoa' && (
          <div className="input-group w-full" style={{ marginTop: '10px' }}>
            <label htmlFor="nomeOutraPessoa">
              Nome da outra pessoa<span className="required">*</span>
            </label>
            <input type="text" id="nomeOutraPessoa" {...register('nomeOutraPessoa')} />
            {errors.nomeOutraPessoa && (
              <span style={{ color: 'red', fontSize: '0.8em' }}>
                {errors.nomeOutraPessoa.message}
              </span>
            )}
          </div>
        )}
      ...
      <div className="input-group w-full">
        ...
        {errors.acompanhamentoOutroLugar && (
          <span style={{ color: 'red', fontSize: '0.8em' }}>
            {errors.acompanhamentoOutroLugar.message}
          </span>
        )}
      </div>

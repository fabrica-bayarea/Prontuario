...
export class AdminAuth {
  ...
  @ApiResponse({ status: 200, description: 'Admin autenticado com sucesso' })
  @ApiResponse({ status: 403, description: 'Credenciais de admin inválidas' })
  @HttpCode(HttpStatus.OK)
  @Post('login')
  async loginAdmin(@Body() dto: AdmSignIn) {
    try {

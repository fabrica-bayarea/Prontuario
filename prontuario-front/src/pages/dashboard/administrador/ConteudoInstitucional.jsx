  ...
  return (
    <SidebarLayout>
      <div style={{ padding: 20 }}>
        ...
        <button style={estilos.btnAdicionar} onClick={() => setModalAberto(true)}>
        ...
        <div style={estilos.filtrosContainer}>
          ...
          />
          <select style={estilos.inputSelect} value={filtroTipo} onChange={(e) => setFiltroTipo(e.target.value)}>
            <option value="">Todos os tipos</option>
            <option value="PDF">PDF</option>
            <option value="Vídeo">Vídeo</option>
            <option value="Texto">Texto</option>
          </select>
          <select style={estilos.inputSelect} value={filtroStatus} onChange={(e) => setFiltroStatus(e.target.value)}>
            <option value="">Todos os status</option>
            <option value="publicado">Publicado</option>
            <option value="rascunho">Rascunho</option>
          </select>
          <select style={estilos.inputSelect} value={filtroPublico} onChange={(e) => setFiltroPublico(e.target.value)}>

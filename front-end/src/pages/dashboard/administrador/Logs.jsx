...
function LogsAuditoria() {
  ...
  useEffect(() => {
    const dadosMockLogs = [
      ...
      },
      {
        ...
        acao: "aprovacao",
        dataHora: "2025-07-01 10:15:30",
        detalhes: "Aprovação de usuário: Pedro Souza",
      },
      {
        id: 3,
        usuario: "Pedro Costa",
        acao: "edicao",
        dataHora: "2025-07-02 11:00:00",
        detalhes: "Edição de prontuário: Ana Lima",
      },
      {
        id: 4,
        usuario: "João Silva",
        acao: "logout",
        dataHora: "2025-07-02 12:30:00",
        detalhes: "Logout",
      },
      {
        id: 5,
        usuario: "Fernanda Dantas",
        acao: "importacao",
        dataHora: "2025-07-03 09:00:00",
        detalhes: "Importação de 100 usuários",
      },
      {
        id: 6,
        usuario: "João Silva",
        acao: "login",
        dataHora: "2025-07-04 08:00:00",
        detalhes: "Login bem-sucedido",
      },
      // ... mais logs
    ];
  ...
  const handleFilter = useCallback(() => {
    ...
    if (dataDe) {
      tempLogs = tempLogs.filter(
        (log) => new Date(log.dataHora) >= new Date(dataDe)
      );
    }
  ...
  }, [logs, filtroNome, filtroAcao, dataDe, dataAte]);
  ...
  return (
    <SidebarLayout>
      <main className="dashboard-main">
        ...
        {/* Filtros */}
        <section
          className="filters-section filtros-wrapper"
        ...
        >
          ...
          />
          <button id="btnFiltrar" onClick={handleFilter}>
            Filtrar Resultados
          </button>
        </section>
        ...
        <section className="tabela-logs" aria-label="Tabela de logs do sistema">
          ...
          <table role="table">
            <caption className="visually-hidden">
              ...
              >
                Logs de ações realizadas pelos usuários no sistema
              </h2>
            </caption>
            <thead>
              <tr>
